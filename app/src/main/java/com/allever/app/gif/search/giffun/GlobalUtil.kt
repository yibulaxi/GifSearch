...
package com.allever.app.gif.search.giffun
...
object GlobalUtil {
    ...
    val appVersionCode: Int
        get() = App.context.packageManager.getPackageInfo(appPackage, 0).versionCode
...
//            logWarn(TAG, e.message, e)
     ...
     * 判断当前版本是否是开源版本。
     */
    fun isOpenSource() = App.context.packageName == "com.quxianggif.opensource"
